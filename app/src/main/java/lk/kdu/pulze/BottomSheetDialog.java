...
public class BottomSheetDialog extends BottomSheetDialogFragment {
  ...
  public View onCreateView(
    ...
    systole.addTextChangedListener(
        new TextWatcher() {
    ...
    diastole.addTextChangedListener(
        new TextWatcher() {
  ...
  private boolean validateFields() {
    ...
    if (systole.getText().length() == 0
        || Integer.parseInt(String.valueOf(systole.getText())) > 500) {
      systoleLayout.requestFocus();
      systoleLayout.setError("Systole value is invalid!");
      return false;
    }
    if (diastole.getText().length() == 0
        || Integer.parseInt(String.valueOf(diastole.getText())) > 500) {
