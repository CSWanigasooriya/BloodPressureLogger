...
public class StatisticsFragment extends Fragment {
  ...
  public View onCreateView(
    ...
    three_month.setOnClickListener(
        new View.OnClickListener() {
          @Override
          public void onClick(View v) {
            resetValues();
    ...
    statListView.setOnTouchListener(
  ...
  private void setAllSelected() {
    if (!pressureModelArrayList.isEmpty()) {
      maxSys =
          Collections.max(
              pressureModelArrayList,
              new Comparator<PressureModel>() {
                @Override
                public int compare(PressureModel o1, PressureModel o2) {
                  if (o1.getSystolic() > o2.getSystolic()) return 1;
                  else if (o1.getSystolic() < o2.getSystolic()) return -1;
                  return 0;
                }
              });
      ...
      maxDia =
          Collections.max(
              ...
              new Comparator<PressureModel>() {
                @Override
                public int compare(PressureModel o1, PressureModel o2) {
                  if (o1.getDiastolic() > o2.getDiastolic()) return 1;
                  else if (o1.getDiastolic() < o2.getDiastolic()) return -1;
                  return 0;
                }
              });
      ...
      maxPul =
          Collections.max(
              ...
              new Comparator<PressureModel>() {
                @Override
                public int compare(PressureModel o1, PressureModel o2) {
                  if (o1.getPulse() > o2.getPulse()) return 1;
                  else if (o1.getPulse() < o2.getPulse()) return -1;
                  return 0;
                }
              });
